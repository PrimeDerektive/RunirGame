...
public class XWeaponTrailDemo : MonoBehaviour 
{
    ...
    void OnGUI()
    {
        ...
        if (GUI.Button(new Rect(0, 0, 150, 30), "Activate Trail1"))
        {
            ...
            ProTrailDistort.DeactivateTrail();
            ProTrailShort.DeactivateTrail();
            ProTraillong.DeactivateTrail();

            SwordAnimation.Play();
            SimpleTrail.ActivateTrail();
        }
        if (GUI.Button(new Rect(0, 30, 150, 30), "Stop Trail1"))
        {

            SimpleTrail.DeactivateTrail();
        }
        ...
        if (GUI.Button(new Rect(0, 120, 150, 30), "Activate Trail2"))
        {
            ...
            SwordAnimation.Play();
            ProTrailDistort.ActivateTrail();
            ProTrailShort.ActivateTrail();
            ProTraillong.ActivateTrail();
        }
