...
public class RagdollHelper : MonoBehaviour {
	...
	public string bellyGetUpState = "GetUpFromBelly";
	public string backGetUpState = "GetUpFromBack";
	...
	void Start ()
	{
		...
		foreach (Component c in components)
		{
			if(!excludedTransforms.Contains(c as Transform)){
