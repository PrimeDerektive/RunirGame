        ...
        public static MonoScript CreateOrEditCustomBlackboard (string path, InternalBlackboard blackboard) {
            try {
                ...
                using (FileStream stream = File.Open(path, FileMode.Create, FileAccess.Write)) {
                    ...
                    // Add header
                    code.AppendLine(CodeGenerator.GetHeader());
                    // Add namespaces
                    ...
                    if (blackboard.GetType().Name == "GlobalBlackboard") {
                        // Add class
                        code.AppendLine("public class " + CodeGenerator.GetClassName(path) + " : InternalGlobalBlackboard {");
                        // Add more one tab
                        code.tabSize += 1;
                        ...
                        // Add class
                        code.AppendLine("public class " + CodeGenerator.GetClassName(path) + " : Blackboard {");
                        // Add more one tab
                        code.tabSize += 1;
                    }
                    ...
                    if (floatVars.Length > 0) {
                        ...
                        for (int i = 0; i < floatVars.Length; i++)
                            code.AppendLine(CodeGenerator.GetVariableMember(floatVars[i]));
                    }
                    ...
                    if (intVars.Length > 0) {
                        ...
                        for (int i = 0; i < intVars.Length; i++)
                            code.AppendLine(CodeGenerator.GetVariableMember(intVars[i]));
                    }
                    ...
                    if (boolVars.Length > 0) {
                        ...
                        for (int i = 0; i < boolVars.Length; i++)
                            code.AppendLine(CodeGenerator.GetVariableMember(boolVars[i]));
                    }
                    ...
                    if (stringVars.Length > 0) {
                        ...
                        for (int i = 0; i < stringVars.Length; i++)
                            code.AppendLine(CodeGenerator.GetVariableMember(stringVars[i]));
                    }
                    ...
                    if (vector3Vars.Length > 0) {
                        ...
                        for (int i = 0; i < vector3Vars.Length; i++)
                            code.AppendLine(CodeGenerator.GetVariableMember(vector3Vars[i]));
                    }
                    ...
                    if (rectVars.Length > 0) {
                        ...
                        for (int i = 0; i < rectVars.Length; i++)
                            code.AppendLine(CodeGenerator.GetVariableMember(rectVars[i]));
                    }
                    ...
                    if (colorVars.Length > 0) {
                        ...
                        for (int i = 0; i < colorVars.Length; i++)
                            code.AppendLine(CodeGenerator.GetVariableMember(colorVars[i]));
                    }
                    ...
                    if (quaternionVars.Length > 0) {
                        ...
                        for (int i = 0; i < quaternionVars.Length; i++)
                            code.AppendLine(CodeGenerator.GetVariableMember(quaternionVars[i]));
                    }
                    ...
                    if (gameObjectVars.Length > 0) {
                        ...
                        for (int i = 0; i < gameObjectVars.Length; i++)
                            code.AppendLine(CodeGenerator.GetVariableMember(gameObjectVars[i]));
                    }
                    ...
                    if (textureVars.Length > 0) {
                        ...
                        for (int i = 0; i < textureVars.Length; i++)
                            code.AppendLine(CodeGenerator.GetVariableMember(textureVars[i]));
                    }
                    ...
                    if (materialVars.Length > 0) {
                        ...
                        for (int i = 0; i < materialVars.Length; i++)
                            code.AppendLine(CodeGenerator.GetVariableMember(materialVars[i]));
                    }
                    ...
                    if (objectVars.Length > 0) {
                        ...
                        for (int i = 0; i < objectVars.Length; i++)
                            code.AppendLine(CodeGenerator.GetVariableMember(objectVars[i]));
                    }
                    ...
                    if (fsmEvents.Length > 0) {
                        ...
                        for (int i = 0; i < fsmEvents.Length; i++)
                            code.AppendLine(CodeGenerator.GetVariableMember(fsmEvents[i]));
                    }
                ...
                return Resources.LoadAssetAtPath(path, typeof(MonoScript)) as MonoScript;
            }
