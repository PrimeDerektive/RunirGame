...
{
internal class StandardShaderGlowGUI : ShaderGUI
{
	...
	private static class Styles
	{
        ...
        public static GUIContent glowTex = new GUIContent("Glow Texture");
        public static GUIContent glowColor = new GUIContent("Glow Color");
        public static GUIContent glowColorMultiplier = new GUIContent("Glow Color Multiplier");
    ...
    MaterialProperty glowTex = null;
    MaterialProperty glowColor = null;
    MaterialProperty glowColorMult = null;
	...
	public void FindProperties (MaterialProperty[] props)
	{
        ...
        glowTex = FindProperty("_GlowTex", props);
        glowColor = FindProperty("_GlowColor", props);
        glowColorMult = FindProperty("_GlowColorMult", props);
    }
	...
	public override void OnGUI (MaterialEditor materialEditor, MaterialProperty[] props)
	{
        ...
        GlowMaterialInspector.ShowGlowMaterialKeywords(material);
	}
	...
	public void ShaderPropertiesGUI (Material material)
	{
		...
		EditorGUI.BeginChangeCheck();
		{
            ...
            m_MaterialEditor.TexturePropertySingleLine(Styles.glowTex, glowTex, null);
            m_MaterialEditor.ShaderProperty(glowColor, Styles.glowColor.text);
            m_MaterialEditor.ShaderProperty(glowColorMult, Styles.glowColorMultiplier.text);
		}
